...
uint32_t id_local_device_registre[]={0x3fb4f1,0x82EFB1,0x830FAB,0x82ed6f}; 
...
void loop() {
     ...
     if(CMD_flag==1){
      ...
      if(flag_reg==0) {
        Serial.print("[Recibido] HEX:"); Serial.print(String(str_bufferRx));  
